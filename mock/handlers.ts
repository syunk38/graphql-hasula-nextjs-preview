...
export const handlers = [
        ...
        users: [
          {
            ...
            name: 'Test user A',
            created_at: '2021-01-13718:06:46.412969+00:00',
          },
          {
            __typename: 'users',
            id: '2607950f-9959-1bc7-834d-5656e4aeaac2',
            name: 'Test user B',
            created_at: '2021-02-13718:06:46.412969+00:00',
          },
          {
            __typename: 'users',
            id: '7fe58619-10ec-5239-6f43-1da15a634aba',
            name: 'Test user C',
            created_at: '2021-03-13718:06:46.412969+00:00',
          },
        ],
      })
    )
  ...
  graphql.query('GetUserById', (req, res, ctx) => {
    ...
    if (id === '2607950f-9959-1bc7-834d-5656e4aeaac2') {
      return res(
        ctx.data({
          users_by_pk: {
            __typename: 'users',
